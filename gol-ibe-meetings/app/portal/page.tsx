  ...
  return (
    <>
      <div className={s.hero}>
        ...
        <p className={s.heroSub}>Search the GOL IBE Meetings knowledge base or browse by topic below.</p>
        <div className={s.searchWrap}>
          <span className={s.searchIcon}>🔍</span>
          <input
            className={s.omnisearch}
            placeholder="Search… e.g. create meeting, approve request, export report"
            value={query}
        ...
        <div className={s.heroChips}>
          {["Create meeting", "Approve request", "Add attendees", "Email templates", "Export report", "User access"].map((chip) => (
      ...
      <div className={s.body}>
        ...
        {debouncedQuery.trim() && (
          <div className={s.quickResults}>
            ...
            {filteredResults.length === 0 ? (
              <p className={s.noResults}>Try a different keyword, or browse by topic below.</p>
            ) : (
        ...
        {!debouncedQuery.trim() && (
          <>
            ...
            <div className={s.panelsRow}>
              ...
              <div className={s.panel}>
                <div className={s.panelHeader}>
                  <span className={s.panelTitle}>Setup Health Check</span>
