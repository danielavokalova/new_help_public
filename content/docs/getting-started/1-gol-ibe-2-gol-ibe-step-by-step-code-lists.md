...
2. Go to **Code Lists** in the left-hand menu.
3. Update the relevant sub-section (Carriers, Destination filters, Blocked emails).
4. After saving, go to **Flush caches** or **Flush HTML caches** to apply the changes immediately.

## Results

Your front-end displays only the airlines and destinations you have enabled, and any restricted email addresses or regions are blocked from making bookings.

## Tips

- Always flush the relevant cache after making changes so customers see the updated configuration immediately
- Use **Destination filters** to limit search results to markets your agency is licensed to sell
- **Blocked emails** is useful for preventing repeat abuse from specific addresses
