...
- Customise the **booking confirmation** email first — it is the most frequently sent notification
- Always set a recognisable **From email** so customers know who the email is from
- Check **Sent notifications** regularly to spot any delivery failures
