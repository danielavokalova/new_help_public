...
Your booking engine queries the correct GDS/NDC sources with optimised response times, giving customers fast and accurate flight search results.

## Tips

- Advanced settings should only be changed by technical staff or in consultation with CEE Systems support
- Always test after any connector change — incorrect settings can break the search entirely
- **Parallel queries** can significantly reduce search response time when multiple PCCs are in use
